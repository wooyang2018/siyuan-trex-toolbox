...
const Svg = {
    ...
    Typography: `<symbol id="iconTypography" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M22,7.24a1,1,0,0,0-.29-.71L17.47,2.29A1,1,0,0,0,16.76,2a1,1,0,0,0-.71.29L13.22,5.12h0L2.29,16.05a1,1,0,0,0-.29.71V21a1,1,0,0,0,1,1H7.24A1,1,0,0,0,8,21.71L18.87,10.78h0L21.71,8a1.19,1.19,0,0,0,.22-.33,1,1,0,0,0,0-.24.7.7,0,0,0,0-.14ZM6.83,20H4V17.17l9.93-9.93,2.83,2.83ZM18.17,8.66,15.34,5.83l1.42-1.41,2.82,2.82Z"/></symbol>`,
    RandomNote: `<symbol id="iconRandomNote" viewBox="0 0 1200 1430" xmlns="http://www.w3.org/2000/svg"><path d="M935.926 42.203v186.061H763.958c-54.408 0-114.484 26.559-164.729 77.32-50.242 50.761-104.842 126.065-191.527 249.904-87.076 124.394-135.567 199.565-165.807 233.346-30.24 33.78-25.376 30.882-69.388 30.882H0v147.863h172.507c66.078 0 132.54-27.619 179.515-80.093s91.312-125.164 176.742-247.208c85.82-122.601 140.381-195.159 175.512-230.651 35.129-35.491 36.641-33.5 59.685-33.5h171.967v194.147L1200 306.276zM0 228.263v147.863h172.507c44.012 0 39.148-2.975 69.388 30.805 19.456 21.734 51.507 67.826 91.49 125.915 5.419-7.773 7.973-11.521 13.708-19.716 21.78-31.114 41.563-59.187 59.838-84.79 6.36-8.91 11.688-15.939 17.714-24.259-27.021-39.039-49.525-70.001-72.623-95.803-46.975-52.474-113.437-80.015-179.515-80.015zm935.926 401.464v189.988H763.958c-23.043 0-24.554 1.915-59.684-33.577-23.237-23.477-56.146-65.093-99.809-124.76-5.281 7.49-9.555 13.418-15.095 21.333-30.571 43.674-51.648 75.183-73.777 107.816 31.395 41.578 58.12 73.875 83.637 99.652 50.242 50.763 110.319 77.397 164.729 77.397h171.968v190.22L1200 893.801z" transform="scale(1.1, 1.2)"/></symbol>`,
    AI: `<symbol id="iconAI" viewBox="0 0 32 32"><rect x="8" y="4" width="2" height="24" rx="0.5" fill="currentColor"/><rect x="22" y="4" width="2" height="24" rx="0.5" fill="currentColor"/><rect x="8" y="4" width="16" height="2" rx="0.5" fill="currentColor"/><rect x="8" y="26" width="16" height="2" rx="0.5" fill="currentColor"/><rect x="10" y="6" width="12" height="20" rx="0.5" fill="currentColor" opacity="0.1"/></symbol>`,
};
